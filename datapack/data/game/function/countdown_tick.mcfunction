...
#3
execute if score $countdown game matches 60 run title @a title {"text":"3","bold":true,"color":"white"}
...
#2
execute if score $countdown game matches 40 run title @a title {"text":"2","bold":true,"color":"white"}
...
#1
execute if score $countdown game matches 20 run title @a title {"text":"1","bold":true,"color":"white"}
...
#GO
execute if score $countdown game matches 1 run title @a title {"text":"GO!","bold":true,"color":"aqua"}
