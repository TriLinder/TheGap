...
#Hotbar
item replace entity @s hotbar.0 with minecraft:iron_sword{HideFlags:127, Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:255s}], CanDestroy:["minecraft:gold_block", "minecraft:blue_stained_glass", "minecraft:red_stained_glass", "minecraft:red_wool", "minecraft:blue_wool"]}
item replace entity @s hotbar.1 with minecraft:iron_pickaxe{HideFlags:127, Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:255s}], CanDestroy:["minecraft:gold_block", "minecraft:blue_stained_glass", "minecraft:red_stained_glass", "minecraft:red_wool", "minecraft:blue_wool"]}
item replace entity @s hotbar.2 with minecraft:bow{HideFlags:127, Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:255s}, {id:"minecraft:infinity",lvl:1s}], CanDestroy:["minecraft:gold_block", "minecraft:blue_stained_glass", "minecraft:red_stained_glass", "minecraft:red_wool", "minecraft:blue_wool"]}
item replace entity @s hotbar.3 with minecraft:shears{HideFlags:127, Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:255s}], CanDestroy:["minecraft:gold_block", "minecraft:blue_stained_glass", "minecraft:red_stained_glass", "minecraft:red_wool", "minecraft:blue_wool"]}
...
execute if entity @s[team=red] run item replace entity @s hotbar.6 with minecraft:red_wool{HideFlags:127, Unbreakable:1b, CanDestroy:["minecraft:gold_block", "minecraft:blue_stained_glass", "minecraft:red_stained_glass", "minecraft:red_wool", "minecraft:blue_wool"], CanPlaceOn:["minecraft:red_wool", "minecraft:blue_wool", "minecraft:red_concrete", "minecraft:blue_concrete", "minecraft:white_concrete"]} 64
...
execute if entity @s[team=blue] run item replace entity @s hotbar.6 with minecraft:blue_wool{HideFlags:127, Unbreakable:1b, CanDestroy:["minecraft:gold_block", "minecraft:blue_stained_glass", "minecraft:red_stained_glass", "minecraft:red_wool", "minecraft:blue_wool"], CanPlaceOn:["minecraft:red_wool", "minecraft:blue_wool", "minecraft:red_concrete", "minecraft:blue_concrete", "minecraft:white_concrete"]} 64
