...
execute if entity @s[team=red] run item replace entity @s armor.head with minecraft:leather_helmet{display:{color:10036257}, HideFlags:127, Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:255s}]}
execute if entity @s[team=red] run item replace entity @s armor.chest with minecraft:leather_chestplate{display:{color:10036257}, HideFlags:127, Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:255s}]}
execute if entity @s[team=red] run item replace entity @s armor.legs with minecraft:leather_leggings{display:{color:10036257}, HideFlags:127, Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:255s}]}
execute if entity @s[team=red] run item replace entity @s armor.feet with minecraft:leather_boots{display:{color:10036257}, HideFlags:127, Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:255s}]}
...
execute if entity @s[team=blue] run item replace entity @s armor.head with minecraft:leather_helmet{display:{color:3290519}, HideFlags:127, Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:255s}]}
execute if entity @s[team=blue] run item replace entity @s armor.chest with minecraft:leather_chestplate{display:{color:3290519}, HideFlags:127, Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:255s}]}
execute if entity @s[team=blue] run item replace entity @s armor.legs with minecraft:leather_leggings{display:{color:3290519}, HideFlags:127, Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:255s}]}
execute if entity @s[team=blue] run item replace entity @s armor.feet with minecraft:leather_boots{display:{color:3290519}, HideFlags:127, Unbreakable:1b, Enchantments:[{id:"minecraft:unbreaking",lvl:255s}]}
