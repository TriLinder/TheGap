...
execute if score @s killStreak matches 3 run tellraw @a ["",{"selector":"@s","color":"aqua"},{"text":" received the "},{"text":"TNT","color":"aqua"},{"text":" item for a kill streak of "},{"score":{"name":"@s","objective":"killStreak"},"color":"aqua"}]

execute if score @s killStreak matches 5 run function game:give_knockback_item
execute if score @s killStreak matches 5 run tellraw @a ["",{"selector":"@s","color":"aqua"},{"text":" received the "},{"text":"Knockback stick","color":"aqua"},{"text":" for a kill streak of "},{"score":{"name":"@s","objective":"killStreak"},"color":"aqua"}]
...
execute if score @s killStreak matches 7 if score @s hasKillStreakItem matches 0 run tellraw @a ["",{"selector":"@s","color":"aqua"},{"text":" received the "},{"text":"Flip!","color":"aqua"},{"text":" Item for a kill streak of "},{"score":{"name":"@s","objective":"killStreak"},"color":"aqua"}]
